...
export function HeroSection() {
  ...
  return (
    <>
      ...
      */}
      <section
        className="relative min-h-[80vh] flex flex-col items-center justify-center overflow-hidden bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        */}
        ...
        <div className="container relative z-10 text-center text-white px-4 py-12">
          <motion.div
